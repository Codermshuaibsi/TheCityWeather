  ...
  if (!session) {
    return (
      <div className="text-white my-60 flex flex-col items-center justify-center text-center px-4">
        ...
        <button  className="bg-green-500 mt-2 mx-30 cursor-pointer absolute text-white px-4 py-2 rounded-md flex items-center justify-center gap-2 hover:bg-green-600 transition"
       onClick={()=>{
        router.push('/')
       }} >Sign now</button>
      </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12  text-white">
      <div className="w-fit  rounded-xl shadow-lg p-8 text-center">
        ...
        <button
          onClick={() => signOut()}
          className="bg-red-500 mx-30 cursor-pointer text-white px-4 py-2 rounded-md flex items-center justify-center gap-2 hover:bg-red-600 transition"
        >
          <LogOut size={18} />
          Sign Out
        </button>
